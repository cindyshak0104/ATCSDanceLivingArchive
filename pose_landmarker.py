...
STEP2: Pose Estimation
 This module: Core pose detection module
 Input: Video frames (images)
 Output: 33-point body landmarks with confidence scores

PURPOSE: Wrapper for MediaPipe's pose landmark detection.
Provides utilities to detect human pose from images and videos.
Used by STEP2 (run_pose_estimation_folder.py) and STEP4 (backend.py).
"""
